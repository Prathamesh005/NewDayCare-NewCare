...
function PdfImpressionForVisit(props) {
  ...
  return (
    <View style={styles.titleContainer} wrap={false}>
      <View style={styles.rowHead}>
        <Text style={styles.descriptionHead}>Impression For Visit</Text>
      </View>
      <View style={styles.content}>
        <View style={styles.leftContainer}>
          <View style={styles.row}>
            <Text style={styles.description}>
              {cancerClinicalImpressions[0] &&
...
export default PdfImpressionForVisit;
