...
function EditAppointmentForm(props) {
  ...
  useEffect(() => {
    ...
    // setAppointmentDateState(moment(props.detailsData.detaildata.startDateTime).format("YYYY-MM-DD"))
    getPractitionerList('');
  }, []);
  ...
  const onSave = (values, { resetForm }) => {
    const patientDetails = {
      display:
        (detailsData.patientDetails &&
          detailsData.patientDetails.patient &&
          detailsData.patientDetails.patient.display) ||
        props.patientData.display,
      fhirResourceId:
        (detailsData.patientDetails &&
          detailsData.patientDetails.patient &&
          detailsData.patientDetails.patient.resourceId) ||
        props.patientData.fhirResourceId,
      first:
        (detailsData.patientDetails &&
          detailsData.patientDetails.patient &&
          detailsData.patientDetails.patient.first) ||
        props.patientData.firstName,
      last:
        (detailsData.patientDetails &&
          detailsData.patientDetails.patient &&
          detailsData.patientDetails.patient.last) ||
        props.patientData.lastName,
      role: 'Patient',
      serviceType: (detailsData.serviceType && detailsData.serviceType) || null,
    };

    const obj = {
      appointmentResourceId: detailsData && detailsData.appointmentResourceId,
      appointmentStatus: detailsData && detailsData.appointmentStatus,
    ...
    console.log(obj);
    setIsLoading(true);
    callUpdateAppointmentAPI(obj);
  };

  const callUpdateAppointmentAPI = async obj => {
  ...
  // console.log("appointmentDateState", appointmentDateState)
  return (
    <>
      <Formik
        initialValues={{
