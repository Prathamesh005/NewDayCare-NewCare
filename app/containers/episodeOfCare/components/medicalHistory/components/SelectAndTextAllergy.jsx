...
const SelectAndTextAllergy = ({
  ...
  useEffect(() => {
    ...
    user.setAllergyData(storedData);
  }, [storedData]);
  ...
  const handleDelete = (ele, index) => {
    ...
    user.setCheckAllergy(true);
  };
  useEffect(() => {
    user.setDelAllergyData(deletedData);
  }, [deletedData]);
...
export default SelectAndTextAllergy;
