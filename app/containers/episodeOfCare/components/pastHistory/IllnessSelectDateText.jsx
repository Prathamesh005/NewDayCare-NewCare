...
const IllnessSelectDateText = ({
  ...
  useEffect(() => {
    ...
    user.setPertainingIllnessData(storedData);
  }, [storedData]);
  ...
  useEffect(() => {
    user.setDelsetPertainingIllnessData(deletedData);
  }, [deletedData]);
...
export default IllnessSelectDateText;
